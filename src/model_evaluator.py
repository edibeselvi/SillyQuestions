...
class ModelEvaluator:
    def __init__(self, api_base_url="http://127.0.0.1:1234", llms_file=os.path.join("data", "llms.txt"), questions_file=os.path.join("data", "sorular.txt")):
    ...
    def run(self):
        ...
        for model_name in models:
            ...
            model_folder = os.path.join(os.getcwd(), "outputs", safe_model_name)
